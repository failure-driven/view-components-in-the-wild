...
feature "Create V3 User", js: true do
  scenario "I can create a V3 user" do
    When "I try to create a new V3 user" do
      visit new_v3_user_path
      page.fill_in("Name", with: "Mi")
      page.fill_in("Email", with: "saramic@gmail")
      page.fill_in("Age", with: "4")
      page.fill_in("Password", with: "asdf")
      page.click_on("Create V3 user")
    end
    ...
    Then "I get errors around all the fields" do
      wait_for do
        ...
        3 errors prohibited this v3_user from being saved:
    ...
    Then "I can successfully create a user" do
      ...
      end.to eq "V3 user was successfully created."
      sleep(2)
    end
  end
end
